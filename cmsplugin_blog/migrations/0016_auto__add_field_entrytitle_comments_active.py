...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntryTitle.comments_active'
        db.add_column('cmsplugin_blog_entrytitle', 'comments_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EntryTitle.comments_active'
        db.delete_column('cmsplugin_blog_entrytitle', 'comments_active')
    ...
    models = {
        ...
        'cmsplugin_blog.entrytitle': {
            ...
            'comments_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
